                ...
                <div class='textePrincipal'>
                    ...
                    <?php
                        try {
                            ...
                            $nom_race = str_replace("'", "''", "Drukhari"); // règle un problème spécifique a ODBC pour Access, lorsqu'il faut échapper un caractère (ici ') php utilise \ mais access utilise ''
