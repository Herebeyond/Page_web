...
try {
    ...
    if ($query) {
        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
            ...
            $raceName = $row['nom_faction'];
            $filePath = "./Factions/" . $raceName . ".php";
                ...
                <div class='textePrincipal'>
                    ...
                    <?php
                        try {
                            ...
                            \$query = \$pdo->query('SELECT * FROM Factions ORDER BY numero;');
                            \$content = '';
                                    ...
                                    <div class='selection'>
                                        <div class='classImgSelection'>
                                            <img class='imgSelection' src='\" . \$imgPath . \"' 
                                                onclick='window.location.href='../\" . htmlspecialchars(\$row['nom_faction'], ENT_QUOTES, 'UTF-8') . \".php'>
                                        </div>
                                        <div class='texteSelection' onclick='window.location.href='../\" . htmlspecialchars(\$row['nom_faction'], ENT_QUOTES, 'UTF-8') . \".php'>
