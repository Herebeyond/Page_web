<html>
    <head>
        ...
        <link rel='stylesheet' href='<?php echo $chemin_absolu . '/style/styleScript.css?ver=' . time()?>'>
        <title>
            $raceName
        </title>
    </head>
    ...
    <body>
        <div id='global'>
            <div id='enTete'>
                ...
                <div id='divTitre'>
                    <a id='Titre'> $raceName </a>
                </div>
                <div id='divacceuil'>
                    <div id='acceuil' onclick='window.location.href="<?php echo $chemin_absolu . "/Accueil.php" ?>"'>
                ...
                <div class='textePrincipal'>
                    ...
                    <?php
                        try {
                            ...
                            $dbPath = 'C:\\xampp\\htdocs\\test\\Web\\BDD\\web_BDD.accdb';
                            $pdo = new PDO("odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};Dbq=$dbPath;");

                            // Récupération des données du tableau Factions
                            $nom_race = str_replace("'", "''", "$raceName"); // règle un problème spécifique a ODBC pour Access, lorsqu'il faut échapper un caractère (ici ') php utilise \ mais access utilise ''
