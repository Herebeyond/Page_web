        ...
        <?php
            try {
                ...
                while ($rowS = $queryS->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<div class='species-item' onclick=\"window.location.href='./Beings_display.php?specie=" . urlencode(str_replace(" ", "_", $specieName)) . "'\">";
                    ...
                    while ($rowR = $queryR->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<li class='race-item' onclick=\"event.stopPropagation(); window.location.href='./Beings_display.php?specie=" . urlencode(str_replace(" ", "_", $specieName)) . "&race=" . urlencode(str_replace(" ", "_", $raceName)) . "'\">";
