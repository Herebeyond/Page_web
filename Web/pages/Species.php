...
require_once "./scriptes/functions.php";
                    ...
                    echo " 
                        <div class='selection'>
                            <div class='classImgSelection'>
                                <img class='imgSelection' src='" . $imgPath . "' onclick=\"window.location.href='./Races_display.php?specie=" . urlencode(str_replace(" ", "_", $specieName)) . "'\">
                                " . $specieName . "
                            </div>
                        </div>
                    ";
